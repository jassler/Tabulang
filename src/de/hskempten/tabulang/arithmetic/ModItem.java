...
public class ModItem implements ArithmeticIF{
    @Override
    public void evaluate(Interpretation i) {
        ...
        BigDecimal sum = new BigDecimal(firstNumber.floatValue()).remainder(new BigDecimal(secondNumber.floatValue()));
        System.out.println("Modulo beider Zahlen: " + sum);
