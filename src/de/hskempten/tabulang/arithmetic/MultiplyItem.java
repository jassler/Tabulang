...
public class MultiplyItem implements ArithmeticIF{
    @Override
    public void evaluate(Interpretation i) {
        ...
        if(secondOp == "Identifier"){
            ...
            BigDecimal sum = new BigDecimal(firstNumber.floatValue()).multiply(new BigDecimal(secondNumber.floatValue()));
            System.out.println("Multiplikation beider Zahlen: " + sum);
