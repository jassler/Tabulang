...
public class DivItem implements ArithmeticIF{
    @Override
    public void evaluate(Interpretation i) {
        ...
        BigDecimal sum = new BigDecimal(firstNumber.floatValue()).divideToIntegralValue(new BigDecimal(secondNumber.floatValue()));
        System.out.println("Division beider Zahlen mit abrunden: " + sum);
