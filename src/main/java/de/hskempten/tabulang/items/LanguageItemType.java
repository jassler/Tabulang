...
public enum LanguageItemType {
    ...
    AGGREGATION_COUNT, AGGREGATION_AVERAGE, TERMR_BRACKET, STATEMENT_IDENTIFIER, TERM_DIRECTIONAL_H, TERM_DIRECTIONAL_V, DISTINCT_ITEM, PREDR_BRACKET, STATEMENT_FUNCALL, LOOP_MARK_WITHOUTIF, LOOP_MARK_WITHIF;
