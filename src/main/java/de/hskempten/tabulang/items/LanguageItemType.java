...
public enum LanguageItemType {
    VLIST_EMPTY, VLIST_ONE, VLIST_MULTI, VARDEF_ASSIGNMENT, VARDEF_PROCEDURALF, TUPEL_MULTI, TUPEL_ONE, TUPEL_EMPTY, TUPEL_INTERVAL,

    TERM_BRACKET, TERM_IDENTIFIER, TERM_LOOP, TERM_ORDINAL, TERM_DIRECTIONAL,
    ...
    AGGREGATION_COUNT, AGGREGATION_AVERAGE, TERMR_BRACKET, STATEMENT_IDENTIFIER, TERM_DIRECTIONAL_H, TERM_DIRECTIONAL_V, DISTINCT_ITEM, PREDR_BRACKET, STATEMENT_FUNCALL, LOOP_MARK_WITHOUTIF, LOOP_MARK_WITHIF, PRED_INDEX;
    ...
    public static int getPrecedence(LanguageItemType type) {
        return switch (type) {
            ...
            case TERMR_DOT -> 9;
            case TERM_IDENTIFIER, TERM_LOOP,
