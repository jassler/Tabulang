...
import de.hskempten.tabulang.interpretTest.InterpreterException;
...
public class FunctionCallNode extends TermNode{
    ...
    public Object evaluateNode(Interpretation interpretation) {
        ...
        // TODO is this way of exception handling a good idea?
        try {
            ...
            if (identifier instanceof InternalLibraryFunction f) {
                ...
                throw new IllegalArgumentException("Identifier " + node.getIdentifier() + " does not refer to a function.");

        } catch(InterpreterException e) {
            throw e;

        } catch(Exception e) {
            throw new InterpreterException(e.getLocalizedMessage(), node.getTextPosition());
        }
    }
