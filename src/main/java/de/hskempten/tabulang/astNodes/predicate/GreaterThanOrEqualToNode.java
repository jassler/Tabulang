...
public class GreaterThanOrEqualToNode extends BinaryPredicateNode {
    ...
    /**
     * Compares two evaluated nodes to decide if left node value is greater than or equal to right node value.
     *
     * @return InternalBoolean with value true if value of left node is greater than or equal to value of right node,
